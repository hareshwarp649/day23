...
namespace CollectFrame4
{
    internal class Program
    {
        static void Main(string[] args)
        {
                ...
                CountAddress binder = new CountAddress();
                int result = 1;
                while (result == 1)
                {
                    ...
                    while (loop == 1)
                    {
                        ...
                        switch (option)
                        {
                            ...
                            case 2:
                                ...
                                SetContact c = book.FindContact(name);
                                if (c == null)
                                {
                            ...
                            case 4:
                                ...
                                string city = Console.ReadLine();
                                foreach (SetContact contact in binder.CityDictionary[city])
                                {
                ...
                foreach (var key in binder.Binder.Keys)
                {
                    ...
                    foreach (SetContact c in binder.Binder[key])
                    {

...
namespace CollectFrame1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            CollectionAddress binder = new CollectionAddress();
            ...
            while (result == 1)
            {
                ...
                CollectionCheck book = new CollectionCheck();
                ...
                while (loop == 1)
                {
                    ...
                    switch (option)
                    {
                        ...
                        case 2:
                            ...
                            CollecAddContact c = book.FindContact(name);
                            if (c == null)
                            {
            ...
            foreach (var key in binder.Binder.Keys)
            {
                ...
                foreach (CollecAddContact c in binder.Binder[key])
                {

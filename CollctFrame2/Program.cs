...
namespace CollctFrame2
{
    internal class Program
    {
            ...
            {
                SearchPersonAddress binder = new SearchPersonAddress();
                ...
                while (result == 1)
                {
                    ...
                    AddressPerson book = new AddressPerson();
                    ...
                    while (loop == 1)
                    {
                        ...
                        switch (option)
                        {
                            ...
                            case 2:
                                ...
                                GetContact c = book.FindContact(name);
                                if (c == null)
                                {
                            ...
                            case 4:
                                ...
                                string city = Console.ReadLine();
                                foreach (GetContact contact in binder.SearchContactsByCity(city))
                                {
                ...
                foreach (var key in binder.Binder.Keys)
                {
                    ...
                    foreach (GetContact c in binder.Binder[key])
                    {
